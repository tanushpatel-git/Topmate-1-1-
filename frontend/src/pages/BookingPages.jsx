...
const BookingPages = () => {
  return (
    <Routes>
      ...
      <Route path="one-to-one/:id" element={<Suspense fallback={<SkeletonBookingProduct />}><OnetoOne /></Suspense>} />
      <Route path="products/:id" element={<Suspense fallback={<SkeletonBookingProduct />}><Products /></Suspense>} />
    </Routes>
  );
};
