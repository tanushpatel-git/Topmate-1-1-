    ...
    return (
        <div className='min-h-screen w-full bg-black'>
            ...
            >
                ...
                {/* Heading */}
                <motion.div variants={item} className='flex items-center justify-center flex-col gap-2 leading-20'>
                    <motion.h1 variants={item} className='text-white text-[80px] font-bold'>
                        {title}
                    </motion.h1>
                    <motion.p variants={item} className='text-white text-[80px] font-bold'>
                        {title2}
                    </motion.p>
                    <motion.p
                        variants={item}
                        className={`text-${theamSet}-500 text-[80px] font-serif font-light italic`}
                    >
                        {title3}
                    </motion.p>
                </motion.div>
                ...
                <motion.div variants={item} className='flex items-center justify-center gap-5'>
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`flex px-4 py-2 items-center justify-center cursor-pointer bg-${theamSet}-500 backdrop-blur-sm rounded-xl`}
                    >
